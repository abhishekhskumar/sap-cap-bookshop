...
- Shipping / Freight / Freight Charges / Handling / Courier / Air Freight / "Shipping & Handling" lines — isFreight=true, lineReason="Freight/shipping — distributed across line items". Match these as whole terms, NOT naive substrings. "Delivery" alone is NOT in this list — a line labeled only "DELIVERY" or "DELIVERY CHARGE" is a separate billable service charge (isFreight=false, lineVerdict="VERIFIED"), NOT a freight line, even when a header freight total also exists on the invoice. Do not suppress it.
...
- A line labeled "DELIVERY" or "DELIVERY CHARGE" — this is a separate billable service charge, NOT a freight line, even if a header freight amount ("FREIGHT CHARGES") also exists on the same invoice. Set isFreight=false and lineVerdict="VERIFIED". Never suppress it as freight.
...
- isFreight=true if description matches (case-insensitive): "shipping", "freight", "freight charges", "estimated travel and shipping", "travel and shipping", "handling", "shipping & handling". "Delivery" alone does NOT qualify — a line labeled only "DELIVERY" or "DELIVERY CHARGE" is a separate billable service charge, not a freight duplication; set isFreight=false and lineVerdict="VERIFIED". Only suppress as isFreight when the description itself names physical freight/shipping movement.
